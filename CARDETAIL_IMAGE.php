...
<head>
	...
	<title>ADAM'S CAR SHAMPOO</title>
...
<body>
  <!-- Creation of div class for the navigation bar of the cardetail_image on this page-->
	<div class="FLEG6">
    ...
    <!-- Creation of div class container containing image of the car detailing product-->
    <div class="container">
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            <span class="blink-one"><h5 class="card-title text-center">ADAM'S CAR SHAMPOO</h5></span>
            <form class="form-signin">
              <div class="form-label-group">
              	<img src="img/folder/CARDETAILING.jpg" width="400" height="400">
              	<hr />
              <center><a class="btn btn-warning btn-xl text-uppercase js-scroll-trigger" href="PRODUCTS.php">PROCEED TO PURCHASE</a></center><br>
              <br>
              <center><a class="btn btn-warning btn-xl text-uppercase js-scroll-trigger" href="PRODUCTS.php">PREVIOUS PAGE</a></center>
            </form>
          </div>
        </div>
      </div>
