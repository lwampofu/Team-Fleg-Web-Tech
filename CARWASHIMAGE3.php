...
<head>
	...
	<title>TURTILE WAX CAR WASH</title>
...
<body>
  <!-- Creation of div class for the navigation bar of the carwash_image on this page-->
	<div class="FLEG6">
    ...
    <!-- Creation of div class container containing image of the car wash product-->
    <div class="container">
    <div class="row">
      <div class="col-lg-10 col-xl-9 mx-auto">
        <div class="card card-signin flex-row my-5">
          ...
          <div class="card-body">
            <span class="blink-one"><h5 class="card-title text-center">TURTILE WAX CAR WASH</h5></span>
            <form class="form-signin">
              <div class="form-label-group">
              	<img src="img/folder/CARWASHIMAGE3.jpg" width="300" height="400">
              	<hr />
